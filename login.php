            ...
            <form action="user_login.php" method="get">
                <div class="form-group">
                    <div class="form-label-group">
                        <input type="text" class="form-control" name="user" placeholder="Username" required="required" autofocus="autofocus">
...
<!--Just download the regular (compressed or not) version of jQuery here and include it in your project.-->
